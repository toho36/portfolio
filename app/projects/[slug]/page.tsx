                        ...
                        {project.externalLink && (
                            <div className="flex justify-center">
                                <a
                                    ...
                                    className="inline-flex items-center rounded-full bg-primary px-8 py-3 text-base font-medium text-primary-foreground transition-all hover:bg-primary/90 hover:scale-105"
                                >
